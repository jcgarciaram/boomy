...
// SetEnvironmentVariables sets boomyDB's necessary environment variables and returns a channel to the caller which gets called at the end of init to let it know it can proceed
